...
const translations: Record<Locale, {
  ...
  es: {
    ...
    saved: 'Tarea guardada correctamente',
  ...
  de: {
    ...
    deleted: 'Aufgabe erfolgreich geloescht',
  ...
  pt: {
    ...
    deleted: 'Tarefa excluida com sucesso',
    saved: 'Tarefa salva com sucesso',
    statusUpdated: 'Status da tarefa atualizado',
  ...
  fr: {
    ...
    deleted: 'Tache supprimee avec succes',
    saved: 'Tache enregistree avec succes',
    statusUpdated: 'Statut de la tache mis a jour',
