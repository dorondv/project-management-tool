...
const translations: Record<Locale, {
  ...
  es: {
    ...
    pageSubtitle: 'Visualiza tus tareas y fechas limite en formato calendario',
  ...
  de: {
    pageTitle: 'Kalender',
    pageSubtitle: 'Sieh deine Aufgaben und Fristen im Kalenderformat',
    addEvent: 'Ereignis hinzufuegen',
    today: 'Heute',
  ...
  pt: {
    pageTitle: 'Calendario',
    pageSubtitle: 'Veja suas tarefas e prazos em formato de calendario',
    addEvent: 'Adicionar evento',
    today: 'Hoje',
    upcomingTasks: 'Proximas tarefas',
    due: 'Vence',
    more: 'mais',
  ...
  fr: {
    ...
    pageSubtitle: 'Consultez vos taches et echeances au format calendrier',
