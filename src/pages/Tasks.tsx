...
const translations: Record<Locale, {
  ...
  es: {
    pageTitle: 'Tareas',
    pageSubtitle: 'Gestiona tus tareas en todos los proyectos',
    newTask: 'Nueva tarea',
    ...
    emptySubtitle: 'Crea tu primera tarea para comenzar',
    emptyCta: 'Crear tarea',
  },
  de: {
    pageTitle: 'Aufgaben',
    pageSubtitle: 'Verwalte deine Aufgaben in allen Projekten',
    ...
    emptySubtitle: 'Erstelle deine erste Aufgabe, um zu starten',
    emptyCta: 'Aufgabe erstellen',
  },
  pt: {
    pageTitle: 'Tarefas',
    pageSubtitle: 'Gerencie suas tarefas em todos os projetos',
    newTask: 'Nova tarefa',
    ...
    emptySubtitle: 'Crie sua primeira tarefa para comecar',
    emptyCta: 'Criar tarefa',
  },
  fr: {
    pageTitle: 'Taches',
    pageSubtitle: 'Gerez vos taches sur tous les projets',
    newTask: 'Nouvelle tache',
    searchPlaceholder: 'Rechercher des taches...',
    statusOptions: {
    ...
    clientLabel: 'Client',
    projectLabel: 'Projet',
    clientOptions: { all: 'Tous les clients' },
    projectOptions: { all: 'Tous les projets' },
    clearFilters: 'Effacer les filtres',
    filteredBy: 'Filtre par :',
    emptyTitle: 'Aucune tache trouvee',
    emptySubtitle: 'Creez votre premiere tache pour commencer',
    emptyCta: 'Creer une tache',
  },
};
